    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.viewImg}>
        <Image
          ...
          source={{ uri: 'https://ih0.redbubble.net/image.851986479.0805/flat,1000x1000,075,f.jpg' }}
        />
      </View>
      ...
      <View style={styles.viewConfirmar}>
        <Link style={styles.btnConfirmar} to={{ screen: "RPGlist" }}>Confirmar</Link>
      </View>
      <View style={styles.viewConfirmar}>
        <Link style={styles.btnConfirmar} to={{ screen: "Login" }}>Retornar</Link>
      </View>
    </SafeAreaView>
  )
}
